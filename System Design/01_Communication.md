...
We can use the _Transport Layer Security_ (TLS)
...
We will focus our attention on a direct communication style called _request-response_, in which a client sends a _request
